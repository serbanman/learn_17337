...
class HistoryService:
    ...
    def _get_user_history(self):
        return History.objects.filter(shard_id=self.user_id, user_id=self.user_id)
...
class ViewsService(HistoryService):
    ...
    def _create_history_entry(self):
        ...
        obj = History.objects.create(shard_id=self.user_id, user_id=self.user_id, video_id=new_video_id)
        print(f'> Inside creation history entry, created: {obj}')
